...
public class NPCSeaNettle {
    ...
    public void initialize(Core core) {
        ...
        sequence[0].clip = new _clip[2];
        sequence[0].clip[0] = new _clip();

        sequence[0].clip[0].delay = 150;
        sequence[0].clip[0].add(90, 91, 93, 90, 91, 92);

        sequence[1] = new Sequence();
        sequence[1].clip = new _clip[2];
        sequence[1].clip[0] = new _clip();

        sequence[1].clip[0].delay = 100;
        sequence[1].clip[0].add(88, 89);
    ...
    public void randomize() {
        ...
        physics.accelerate_x = -1*((float)value)/10000;
    ...
    public void process() {
        ...
        if (sequence[1].index == 1)
            ...
            core.sprite_manager.add(secondary_pattern, x+28, y);
